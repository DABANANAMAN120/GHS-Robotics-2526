...
public class GhostController {
  ...
  public double leftTrigger(){return stickValues.getValue(StickValues.leftTrigger);}
  public double rightTrigger(){return stickValues.getValue(StickValues.rightTrigger);}
  ...
  public boolean leftBumper(){return buttonValues.getValue(ButtonValues.leftBumper);}
  public boolean rightBumper(){return buttonValues.getValue(ButtonValues.rightBumper);}
